...
public class AddCustomer extends JFrame implements ActionListener
{
 ...
 checkntime= new JLabel(""+date);
 checkntime .setBounds(200,320,220,20);
 checkntime .setFont(new Font("Tahoma",Font.BOLD,10));
  add(checkntime );
 ...
 public static void main(String arg[])
 {
    ...
    public void actionPerformed(ActionEvent ae) 
    {
     if(ae.getSource() == add)
     {
      ...
      String time =checkntime.getText();
      ...
      con.s.executeUpdate(query2);
        ...
        JOptionPane.showMessageDialog(null, "New Customer Added Successsfully!!!");
       setVisible(false);
       new Reception();
