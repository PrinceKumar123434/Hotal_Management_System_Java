 ...
 public static void main(String arg[])
 {
   new Checkout();  
    ...
    public void actionPerformed(ActionEvent ae) {
     ...
     {
     String s1="delete from customer where number ='"+ccustomer.getSelectedItem()+"' "; 
     String s2="update room set availability = 'Available' where roomnumber = '"+lblroomnumber.getText()+"'";
