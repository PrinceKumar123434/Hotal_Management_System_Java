...
{
 JButton newCustomer ;
 JButton rooms,department,allEmployee,managerInfo,customer,searchRoom,update,roomStatus,pickup, checkout,logout;
 Reception()
 {
  ...
  newCustomer.setBounds(10,10,200,30);
  ...
  customer .setBounds(10,170,200,30);
  ...
  add( managerInfo);
   ...
   update.setBounds(10,290,200,30);
   ...
   roomStatus.setBounds(10,330,200,30);
   ...
   pickup.setBounds(10,370,200,30);
  ...
  image.setBounds(240, 10,500,470);
  add(image);  
